              ...
              <div className="px-6 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-12">
                ...
                <div className="space-y-5 font-[family-name:var(--font-body)] text-[1.08rem] leading-[1.82] text-[#5f4b37] sm:text-[1.13rem] lg:text-[1.16rem]">
                  <p className="text-[1.12rem] leading-[1.88] text-brass-dark sm:text-[1.18rem]">
                    One of my students just finished a meal at my dining table. She loved the food. Spontaneously, she said <span className="font-[family-name:var(--font-display)] text-[1.2em] font-semibold tracking-[0.02em] text-[#8b6a3f]">&ldquo;SO MUCH LOVE!&rdquo;</span> It almost became the title of this book!
                  </p>
                  ...
                  <p>
                    Though Amma passed away in 2021, her legacy of great food continues in my kitchen. How? Well, that is of course material for another <span className="font-medium text-brass-dark">food log</span>.
                  </p>

                  <p>
                    And yes, for me, as someone who loves food, I love Amma&rsquo;s particular brand of Kerala cuisine. For me, love is having a Pulichery, or a Sambar, or an Avial. Sometimes Dosa with Dosa Podi. And revel in the fond memories evoked by Semia Payasam.
                  </p>
