              ...
              {isCheckoutVisible ? (
                ...
                <>
                  ...
                  <div className="mb-6 flex items-center gap-4">
                    <div className="shrink-0">
                      <div className="flex items-end gap-2">
                        <span className="font-[family-name:var(--font-display)] text-lg font-extrabold text-brass-dark/60 line-through decoration-brass-dark/60 decoration-1 sm:text-xl">
                          ₹999
                        </span>
                  ...
                  <p className="mt-3 text-sm text-text-muted">
                    *Packing and shipping is extra. The book will be available for sale in the fourth week of April 2026. I will personally communicate when it is ready for shipping and let you know the charges then. Arun
                  </p>
                </>
              )}
            </div>
