...
export default function Hero() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden pt-24 pb-16 lg:pt-28">
      ...
      <div className="relative mx-auto max-w-6xl px-6 lg:px-8">
        {/* Subtitle — mobile only (above book) */}
        <p
          className="mb-4 font-[family-name:var(--font-sans)] text-[0.78rem] font-medium uppercase tracking-[0.22em] text-brass/45 lg:hidden"
        ...
        <div className="order-2 flex flex-col justify-center lg:order-2">
          ...
          <p
            className="mb-6 hidden font-[family-name:var(--font-sans)] text-[0.78rem] font-medium uppercase tracking-[0.22em] text-brass/45 lg:block"
            style={{ animation: "breatheIn 0.8s ease-out 0.5s both" }}
          >
            A Cookbook by Arun Pandala
          </p>
        ...
        <div className="order-1 flex items-center justify-center lg:order-1">
          <div className="relative">
            <div className="overflow-hidden rounded-[var(--radius-xl)] border border-brass/10 bg-[rgba(255,250,243,0.8)] p-3 shadow-[0_20px_50px_var(--shadow)]">
              <img
                src="/book-cover.png"
                alt="Food for the Soul by Arun Pandala — book cover"
                className="block w-full max-w-md rounded-[var(--radius-lg)] object-cover"
                style={{
